...
public class CustomLogger
{
    ...
    public CustomLogger(LogLevel logLevel)
    {
        ...
        this._logDirectoryPath = Path.Combine(Directory.GetCurrentDirectory(), this._logDirectoryName);
        String logFileName = $"{DateTime.Now:yyyyMMdd_HHmmss}.log";
        this._logFilePath = Path.Combine(this._logDirectoryPath, logFileName);
    ...
    public void CleanupOldLogs()
    {
        ...
        String[] logFiles = Directory.GetFiles(this._logDirectoryName);
